...
public class MyArticleAdapter extends RecyclerView.Adapter<MyArticleAdapter.ViewHolder> {
    ...
    public MyArticleAdapter(List<ModelClass> articleList,Context articleContext) {
    ...
    @NonNull
    @Override
    public MyArticleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        try {
            ...
            holder.articleCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(articleContext, ViewMyArticle.class);
